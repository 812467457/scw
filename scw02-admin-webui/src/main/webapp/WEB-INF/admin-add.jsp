                ...
                <div class="panel-body">
                    ...
                    <form action="admin/save.html" method="post" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="loginAcct" class="form-control" id="exampleInputAcct1" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="userName"  class="form-control" id="exampleInputUsername1" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
